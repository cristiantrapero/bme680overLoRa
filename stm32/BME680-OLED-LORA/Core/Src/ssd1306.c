...
//	Enviar cualquier cambio en el búfer de la pantalla
...
void ssd1306_DrawPixel(uint8_t x, uint8_t y, SSD1306_COLOR color)
{
	...
	// Ponemos el color adecuado para el píxel
	if (color == White)
	{
...
char ssd1306_WriteChar(char ch, FontDef Font, SSD1306_COLOR color)
{
	...
	// A ver si hay espacio en esta línea
	//
	...
	// We gaan door het font  Vamos a través de la fuente
	...
	// La posición actual se mueve
	//
	SSD1306.CurrentX += Font.FontWidth;
	
	// We geven het geschreven char terug voor validatie
	// Damos el caracter efectivo de nuevo para la validación
	return ch;
}
...
//	color => Black or White
// 		Función para escribir una cadena entera
...
char ssd1306_WriteString(char* str, FontDef Font, SSD1306_COLOR color)
{
	...
	while (*str) 
	{
		if (ssd1306_WriteChar(*str, Font, color) != *str)
		{
			...
			// El caracter no está escrito correctamente
			return *str;
		}
